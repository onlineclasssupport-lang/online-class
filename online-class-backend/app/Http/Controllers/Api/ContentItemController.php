...
class ContentItemController extends Controller
{
    ...
    public function publicIndex(Request $request, string $section)
    {
        ...
        $items = ContentItem::section($section)
            ->active()
            ->orderBy('sort_order')
    ...
    {
        $request->validate(['section' => ['required', Rule::in(ContentItem::SECTIONS)]]);
    ...
    private function validateItem(Request $request, ?int $ignoreId = null): array
    {
        $validated = $request->validate([
            'section' => ['required', Rule::in(ContentItem::SECTIONS)],
    ...
    {
        if (! in_array($section, ContentItem::SECTIONS, true)) {
