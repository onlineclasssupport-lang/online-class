...
Route::get('/site-settings/logo', [SiteSettingsController::class, 'streamLogo']);
Route::get('/custom-sections', [SiteSettingsController::class, 'getCustomSections']);
Route::get('/reviews', [ReviewController::class, 'getPublicReviews']);
...
Route::post('/auth/google/exchange', [GoogleOAuthController::class, 'exchange'])->middleware('throttle:10,1');
...
Route::middleware('user.auth')->group(function () {
    ...
    // Student Reviews & Ratings from Main Dashboard (only after login)
    Route::get('/user/my-review', [ReviewController::class, 'getMyReview']);
    Route::post('/user/reviews', [ReviewController::class, 'storeOrUpdate']);
});
...
Route::middleware('admin.auth')->prefix('admin')->group(function () {
    ...
    Route::delete('/site-settings/logo', [SiteSettingsController::class, 'removeLogo']);
    Route::post('/custom-sections', [SiteSettingsController::class, 'addCustomSection']);
    Route::put('/custom-sections/{key}', [SiteSettingsController::class, 'updateCustomSection']);
    Route::delete('/custom-sections/{key}', [SiteSettingsController::class, 'deleteCustomSection']);
    ...
    // Student Reviews & User Login Analytics
    Route::get('/reviews', [ReviewController::class, 'adminIndex']);
    Route::patch('/reviews/{id}/feature', [ReviewController::class, 'adminToggleFeature']);
    Route::delete('/reviews/{id}', [ReviewController::class, 'adminDestroy']);
    Route::get('/user-logins-stats', [ReviewController::class, 'adminLoginStats']);
});
